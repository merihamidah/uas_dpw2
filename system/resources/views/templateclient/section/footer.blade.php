            <footer>
                <div class="footer">
                        ...
                        <div class="border1">
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                    ...
                                    <img class="logo1" src="{{ url('public') }}/client/images/logo1.jpg" />
                                </div>

                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">

                                    <ul class="lik">
                                        <li> <a href="{{ url('templateclient') }}">Beranda</a></li>
                    ...
                    <div class="copyright">
                        <p>Copyright 2019 All Right Reserved By <b>https://urFuniture</b> </p>
                    </div>
